...
- `skills/orchestrator-telemetry/SKILL.md` — telemetry line format, context manifest bucket taxonomy.
- `skills/orchestrator-dispatch/SKILL.md` — post-dispatch artifact gate that enforces this protocol.
- `skills/review-report/references/summary-skeleton.md` — `summary.md` skeleton showing where each footer piece lands.
