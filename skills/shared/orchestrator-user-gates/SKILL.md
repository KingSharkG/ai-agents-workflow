...
**Block 4 — Approval menu** (`AskUserQuestion`). The full option set, signature hashing rule, and 5-iteration loop cap live in `${CLAUDE_PLUGIN_ROOT}/skills/shared/orchestrator-user-gates/references/p1-gate-rules.md`. Read once per session.
