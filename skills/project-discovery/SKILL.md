...
description: Non-mutating discovery of the consumer repo's ecosystems, frameworks, quality-gate commands, and monorepo shape. Use when init is classifying a project or update is refreshing owned sections.
---
