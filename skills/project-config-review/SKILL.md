...
description: Review-and-comment gate before the init agent writes PROJECT_CONFIG.md. Use on every init, update, add, or remove mutation. Shows change summary plus preview or diff, requires explicit approval, loops on comments.
---
